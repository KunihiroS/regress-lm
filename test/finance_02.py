...
def main():
    ...
    finetune_data_dir = os.path.join(PROJECT_ROOT, "test/data/finance_02/finetuning/")
    ...
    test_file_path = os.path.join(PROJECT_ROOT, "test/data/finance_02/test_target.yml")
